  ...
  if(TARGET capnp_tool)
    if(NOT CAPNP_EXECUTABLE)
      ...
      if(CMAKE_CROSSCOMPILING)
        _MAKE_CROSSCOMPILING_WRAPPER("${CAPNP_EXECUTABLE}" CAPNP_EXECUTABLE)
      endif()
    endif()
    if(NOT CAPNPC_CXX_EXECUTABLE)
      get_target_property(CAPNPC_CXX_EXECUTABLE capnpc_cpp CAPNPC_CXX_EXECUTABLE)
      if(CMAKE_CROSSCOMPILING)
        _MAKE_CROSSCOMPILING_WRAPPER("${CAPNPC_CXX_EXECUTABLE}" CAPNPC_CXX_EXECUTABLE)
      endif()
    endif()
...
function(_MAKE_CROSSCOMPILING_WRAPPER EXE_PATH WRAPPER_PATH)
  string(JOIN "\" \"" quoted_emulator_command ${CMAKE_CROSSCOMPILING_EMULATOR})
  set(quoted_emulator_command "\"${quoted_emulator_command}\"")
  if(CMAKE_HOST_WIN32)
    set(wrapper_path "${EXE_PATH}.bat")
    file(GENERATE OUTPUT "${wrapper_path}"
         CONTENT "@${quoted_emulator_command} \"${EXE_PATH}\" %*\r\n"
         FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE)
  else()
    set(wrapper_path "${EXE_PATH}.sh")
    file(GENERATE OUTPUT "${wrapper_path}"
         CONTENT "#!/bin/sh\n${quoted_emulator_command} \"${EXE_PATH}\" \"$@\"\n"
         FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE)
  endif()
  set(${WRAPPER_PATH} "${wrapper_path}" PARENT_SCOPE)
endfunction()